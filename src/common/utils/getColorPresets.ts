...
export const colorPresets = [
  ...
  {
    name: 'pink',
    lighter: '#FFE3F1', // Màu rất nhạt
    light: '#FAB8DC', // Màu nhạt
    main: '#F9ACD6', // Màu chính
    dark: '#C778A7', // Màu tối hơn
    darker: '#8A4F75', // Màu rất tối
...
export const pinklPreset = colorPresets[6];
